<p align="center">
  <img src="docs/_static/logo.svg" alt="annuity-pricing" width="480">
</p>
...
> **Regulatory Disclaimer**: The VM-21 and VM-22 modules are **prototype implementations** for educational
> purposes only. They do not use NAIC-prescribed scenarios and are not suitable for regulatory filings.
> See [AG43 Compliance Gap Analysis](docs/regulatory/AG43_COMPLIANCE_GAP.md) for detailed scope documentation.

### Data Requirements

> **WINK Data**: This library was developed using [WINK](https://www.winkintel.com/) competitive rate data,
> which is **proprietary and not included** in this repository. All examples and CI tests use synthetic
> data generated by the built-in synthetic data provider (`ANNUITY_USE_SYNTHETIC=1`). To use real WINK
> data, obtain a license from WINK and place the parquet file as documented in `CLAUDE.md`.
