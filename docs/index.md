...
@software{annuity_pricing,
  ...
  year = {2025},
  url = {https://github.com/brandon-behring/annuity-pricing}
}
```
...
MIT License. See [LICENSE](https://github.com/brandon-behring/annuity-pricing/blob/main/LICENSE) for details.
