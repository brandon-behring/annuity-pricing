...
@article{behring2025annuitypricing,
  ...
  year = {2025},
  note = {https://github.com/bbehring/annuity-pricing}
}
```
...
- **Paper content**: Contact author directly or open a GitHub issue at https://github.com/bbehring/annuity-pricing
