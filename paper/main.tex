...
\begin{itemize}
  ...
  \item \textbf{Open-source infrastructure}: 953 unit tests, CI/CD, PyPI distribution, Sphinx documentation, reproducible artifacts
\end{itemize}
...
\begin{figure}[htbp]
  ...
  \caption{Black-Scholes validation against financepy. All metrics (price, delta, gamma, vega, theta, rho) within 0.01\% relative error. Source: \texttt{scripts/figures/plot\_bs\_parity.py}.}
  \label{fig:bs_parity}
\end{figure}
